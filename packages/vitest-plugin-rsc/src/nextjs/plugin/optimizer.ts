...
const nextEdgeAppPageOptimizeDeps = [
  "next/dist/compiled/@opentelemetry/api",
  ...
  "next/dist/lib/fallback",
  "next/dist/lib/interop-default",
  "next/dist/lib/metadata/get-metadata-route",
  "next/dist/lib/metadata/get-metadata-route.js",
  ...
  "next/dist/server/stream-utils/encoded-tags",
  ...
  "next/dist/shared/lib/router/utils/get-segment-param",
...
export function resolveNextOptimizeDeps(root: string) {
  return {
    ...
    edgeAppPage: filterResolvableOptimizeDeps(root, nextEdgeAppPageOptimizeDeps),
