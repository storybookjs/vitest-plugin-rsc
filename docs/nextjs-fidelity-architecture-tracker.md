...
| `plugin/aliases.ts`            | `src/build/webpack-config.ts`                               | Next webpack alias/condition config                          | It selects Next aliases/conditions for Vite, so it belongs under the webpack-config mirror.                                                                                                           |
| `plugin/aliases.test.ts`       | `src/build/webpack-config.test.ts` or adjacent focused test | Same                                                         | Test follows implementation.                                                                                                                                                                          |
| `swc-transform-plugin.ts`      | `src/build/webpack/loaders/next-swc-loader.ts`              | `next-swc-loader` / SWC options                              | Vite transform adapter for Next compiler behavior.                                                                                                                                                    |
| `swc-transform-plugin.test.ts` | `src/build/webpack/loaders/next-swc-loader.test.ts`         | Same                                                         | Test follows implementation.                                                                                                                                                                          |
...
| Current file                           | Target path                                                    | Source it mirrors              | Notes                                                         |
| -------------------------------------- | -------------------------------------------------------------- | ------------------------------ | ------------------------------------------------------------- |
| `font-loader-plugin.ts`                | `src/build/webpack/loaders/next-font-loader/index.ts`          | `next-font-loader`             | Vite loader/transform wrapper should delegate to mirror file. |
| `font-loader-plugin.test.ts`           | `src/build/webpack/loaders/next-font-loader/index.test.ts`     | Same                           | Test follows implementation.                                  |
| `image-plugin.ts`                      | `src/build/webpack/loaders/next-image-loader/index.ts`         | `next-image-loader`            | Static image import behavior belongs there.                   |
| `image-plugin.test.ts`                 | `src/build/webpack/loaders/next-image-loader/index.test.ts`    | Same                           | Test follows implementation.                                  |
| `metadata-image-loader-plugin.ts`      | `src/build/webpack/loaders/next-metadata-image-loader.ts`      | `next-metadata-image-loader`   | Metadata image import behavior belongs there.                 |
| `metadata-image-loader-plugin.test.ts` | `src/build/webpack/loaders/next-metadata-image-loader.test.ts` | Same                           | Test follows implementation.                                  |
| `plugin/root-params.ts`                | `src/build/webpack/loaders/next-root-params-loader.ts`         | Next root params loader        | Move behavior to mirror path.                                 |
| `plugin/root-params.test.ts`           | `src/build/webpack/loaders/next-root-params-loader.test.ts`    | Same                           | Test follows implementation.                                  |
| `plugin/cache-handlers.ts`             | `src/server/use-cache/handlers.ts`                             | Next cache handler registry    | Move if it mirrors cache handler behavior.                    |
| `plugin/cache-handlers.test.ts`        | `src/server/use-cache/handlers.test.ts`                        | Same                           | Test follows implementation.                                  |
| `plugin/use-cache.ts`                  | `src/server/use-cache/use-cache-wrapper.ts`                    | Next use-cache wrapper/runtime | Move if it mirrors Next cache runtime call shape.             |
| `plugin/use-cache.test.ts`             | `src/server/use-cache/use-cache-wrapper.test.ts`               | Same                           | Test follows implementation.                                  |
